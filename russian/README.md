...
| ----------- | ----------- |
| Ctrl + A   | Перейдите в начало строки, в которой вы в настоящее время печатаете. Это также работает для большинства полей ввода текста в системе. Netbeans является одним исключением |
